...
const About = () => {
  return (
        <div class="p-8">
            ...
            <div class="grid grid-cols-2 justify-center p-8">
            <p class="col-start-1 text-lg p-4">I graduated from UT Austin with a BA in Sociology. Since then, I mostly
                ...
                <img src={propic} class="h-48 w-48 rounded-full col-start-2 object-cover object-right"/>
            </div>
