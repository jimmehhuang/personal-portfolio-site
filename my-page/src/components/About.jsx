...
const About = () => {
  return (
        <div className="p-8 min-h-screen section">
            ...
            <div className="mb-auto flex flex-wrap">
                <p className="text-md ">My hobbies include video games, obstacle course races, cooking, 
