...
const Home = () => {
    ...
    return (
        <div className="top-0 static w-full min-h-screen m-auto text-center flex flex-col section">
            <NavBar/>
            <div className="m-auto my-48 flex flex-col items-center justify-items-center">
                ...
                <button className='my-2 h-8 w-36 border-2 border-white text-semibold hover:bg-white hover:text-[#2BC6AA]'>
                    Come on in!
                </button>
            </div>
